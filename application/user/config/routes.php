...
$route['checkout/(:any)/payment_confirm'] = 'konfirmasi/get/$1';
$route['checkout/(:any)/payment_confirm/simpan'] = 'konfirmasi/simpan';
$route['checkout/(:any)/success'] = 'konfirmasi/success';
