        ...
        <div class="row mb-5">
            ...
            <div class="col-lg-12">
                ...
                <table class="table table-bordered table-responsive-md">
                    ...
                    <tr>
                        <td><p class="c-cart-productname ml-5"><a href="<?= base_url('Detil'); ?>">Tank with V-Neck and
                                    Panel Detail</a></p></td>
                    ...
                    <tr>
                        <td><p class="c-cart-productname ml-5"><a href="detail-item.html">Lavish Alice Deep Bandeau
                                    Asymmetric</a></p></td>
