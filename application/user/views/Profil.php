            ...
            <div class="col-lg-9 c-color-profil">
                ...
                <form action="profil/simpan" method="post">
                    ...
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="text" class="form-control" id="inputEmail" value="<?= $profil->pengguna_nama; ?>"
                    ...
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="email" class="form-control" id="inputPhone" name="email"
                               value="<?= $profil->pengguna_email; ?>" autocomplete="off">
                    </div>
                    <div class="form-group col-md-6 ">
                        <label for="inputAddress" class="col-form-label">Phone Number <span class="c-form-star">*</span></label>
                        <input type="text" class="form-control" id="inputNumber" value="<?= $profil->pengguna_telp; ?>"
