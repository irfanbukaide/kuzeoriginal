    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="hero-content pb-2 pt-2 text-center">
                <h2 class="hero-heading">Best Seller</h2>
            </div>
        </div>
    </section>

    <div class="container" ng-app="kuze" ng-controller="BestSellerController">
        <!-- Grid -->
            ...
            <header class="product-grid-header">
                ...
                <div class="mb-3 d-flex align-items-center"><span class="d-inline-block mr-1">Sort by</span>
                    <select class="custom-select w-auto border-0">
                        <option value="orderby_0">Name : A-Z</option>
                        <option value="orderby_1">Name : Z-A</option>
                        <option value="orderby_2">Price : Lowest</option>
                        <option value="orderby_3">Price : Higher</option>
                    </select>
                </div>
            </header>
            <div class="row">
