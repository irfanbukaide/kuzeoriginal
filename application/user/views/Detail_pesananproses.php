                        ...
                        <?php if ($orders->orders_status > 2): ?>
                            <div class="row ml-3 mr-2 mt-2">
                                ...
                                <div class="col-md-5 col-sm-12">
                                    <div class="c-order-info">
                                        <p class="mb-2"><i class="fa fa-credit-card mr-2"></i> <b>Rekening Transfer</b>
                                        </p>
                            ...
                            <div class="row ml-3 mr-2 mt-2">
                                <div class="col-md-7 col-sm-12">
                                    <div class="c-order-info">
                                        <p class="mb-2"><i class="fa fa-address-book mr-2"></i> <b>Alamat Pengiriman</b>
                                        </p>
                        ...
                        <div class="c-cart-total col-lg-5 col-md-6 col-sm-7 float-right p-0">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td><span id="rupiah" class="c-price-cart-3 pl-3"><?= $biaya_subtotal(); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="p-1 pl-4">Pengiriman</th>
                                    <td><span id="rupiah"
                                              class="c-price-cart-3 pl-3"> <?= $biaya_pengiriman(); ?></span>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <a href="<?= site_url('order_status'); ?>" class="btn btn-csr c-btn-cart mt-3 float-right">Konfirmasi
                                Pembayaran</a>
                        </div>
                    </div>
                </div>
