        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body container pt-4 pb-4 text-small">
                        ...
                        <br> - Once you have found an item, choose your size and click on the 'ADD TO CART' button on
                        the product page.
                        <br> - Review the items in your shopping bag by clicking the 'SHOPPING CART' link at the top of
                        the page.
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body container pt-4 pb-4 text-small">
                        Please be assured that we take data protection seriously, and your information will only be
                        shared with third parties where they abide by applicable data protection legislation. For more
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body container pt-4 pb-4 text-small">
                        Delivery time frame is between 10-12 working days and depending on the shipping company you
                        choose
                    </div>
                </div>
            </div>
